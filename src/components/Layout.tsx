            ...
            <div className="flex-1 flex items-center justify-center">
              <Link href="/">
                <a className="flex items-center text-gray-900">
                  <div className="group">
                    <div className="rounded-full w-12 h-12 flex items-center justify-center mr-4 group-hover:hidden">
                      <EyeClosed />
                    </div>
                    <div className="rounded-full w-12 h-12 items-center justify-center mr-4 hidden group-hover:flex">
                      <EyeSlash />
                    </div>
                  </div>
                </a>
      ...
      <footer className="max-w-6xl mx-auto px-6">
        <div className="py-6 border-t border-gray-100 text-center flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-600 text-sm">
            <a
              href="mailt:website@nbdyknows.com"
              title="Email us"
              target="_blank"
            ...
            {' '}
            <a
              href="https://twitter.com/nbdyknowsdotcom"
              title="Follow us on Nbdy Knows on Twitter"
              target="_blank"
              rel="noopener noreferrer"
              className="ml-0.5 text-gray-800 hover:text-blue-600"
            >
