  ...
  return (
    <div className="max-w-2xl mx-auto prose prose-blue">
      ...
      <p>
        ...
        wrong with your order, please send email to our{' '}
        <a href="mailto:help@nbdyknows.com">helpdesk.</a>
      </p>

      <h2>Do you offer refunds?</h2>
      <p>
        Refunds are only offered to customers that receive the wrong items or
        damaged items. If any of these apply, please reach out to our <a href="mailto:help@nbdyknows.com">helpdesk.</a> with photos of wrong/damaged items and we&apos;ll
      ...
      <p>
        ...
        that&apos;s the case, please reach out to our <a href="mailto:help@nbdyknows.com">helpdesk.</a> within a week after receiving your order. Include your order
